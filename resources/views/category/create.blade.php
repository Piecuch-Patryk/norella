...
@section('header')
    <header class="custom--bg container-fluid d-flex align-items-center justify-content-center">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center text-light">Dodaj nową kategorię</h1>
            </div>
        </div>
    </header>
@endsection
            ...
            <div class="col-12 col-lg-6 mx-auto">
                <form method="POST" action="{{route('category.store')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="w-100 p-2 rounded-1">{{old('descritpion')}}</textarea>
                      @error('description')
                        <p class="text-danger">{{$message}}</p>
                      @enderror
                    </div>
